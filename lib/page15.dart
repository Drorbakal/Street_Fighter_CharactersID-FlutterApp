      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Column(
            ...
            children: <Widget>[
              Image.asset('assets/marisasubmit.gif', width: 100, height: 100),
              SizedBox(height: 16),
              Text('Marisa'),
            ],
          ),
      ...
      body: Padding(
        ...
        child: Column(
            ...
            children: <Widget>[
              Center(
                child: CircleAvatar(
                  backgroundImage: AssetImage('assets/marisa.jpeg'),
                  radius: 40.0,
                ),
              ),
              Divider(
              ...
              SizedBox(height: 30.0),
              Text("An up-and-coming jewelry designer from Italy who claims ancestry to ancient Greek warriors."
                  " As a child, she was inspired by a vision of the Colosseum in its prime. Today,"
                  " she seeks glory with a smile—and an eye for beauty.",
                style:TextStyle(
                  color: Colors.grey,
                  fontSize: 10.0,
                  fontWeight: FontWeight.bold,
