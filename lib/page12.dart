      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Column(
            ...
            children: <Widget>[
              Image.asset('assets/blankasubmit.gif', width: 100, height: 100),
              SizedBox(height: 16),
              Text('Blanka'),
            ],
          ),
      ...
      body: Padding(
        ...
        child: Column(
            ...
            children: <Widget>[
              Center(
                child: CircleAvatar(
                  backgroundImage: AssetImage('assets/blanka.jpg'),
                  radius: 40.0,
                ),
              ),
              Divider(
              ...
              SizedBox(height: 30.0),
              Text("A kindhearted defender of nature,"
                  " Blanka has become an adventure tour guide,"
                  " confident his intimate knowledge of the jungle will serve as a springboard to fame—and a "
                  "comfortable life for his beloved mother.",
                style:TextStyle(
                  color: Colors.grey,
                  fontSize: 10.0,
                  fontWeight: FontWeight.bold,
