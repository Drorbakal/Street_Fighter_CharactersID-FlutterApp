      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Column(
            ...
            children: <Widget>[
              Image.asset('assets/kensubmit.gif', width: 100, height: 100),
              SizedBox(height: 16),
              Text('Ken'),
            ],
          ),
      ...
      body: Padding(
        ...
        child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 30.0),
              Text('Former US National Fighting Champ,'
                  ' and ex-VP of the Masters Foundation.'
                  ' Accusations of orchestrating a criminal plot have forced Ken to abandon his family and'
                  ' business and go into hiding.',
                style:TextStyle(
                  color: Colors.grey,
                  fontSize: 10.0,
                  fontWeight: FontWeight.bold,
